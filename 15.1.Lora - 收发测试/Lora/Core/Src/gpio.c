...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, LORA1_CS_Pin|LORA1_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LORA1_CS_Pin LORA1_RST_Pin */
  GPIO_InitStruct.Pin = LORA1_CS_Pin|LORA1_RST_Pin;
