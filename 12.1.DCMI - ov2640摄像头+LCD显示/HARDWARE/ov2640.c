...
#define  OV2640_PWDN_High	HAL_GPIO_WritePin(OV_PWON_GPIO_Port,OV_PWON_Pin,GPIO_PIN_SET)
#define  OV2640_PWDN_Low	HAL_GPIO_WritePin(OV_PWON_GPIO_Port,OV_PWON_Pin,GPIO_PIN_RESET)
#define  OV2640_RST_High	HAL_GPIO_WritePin(OV_RESET_GPIO_Port,OV_RESET_Pin,GPIO_PIN_SET)
#define  OV2640_RST_Low		HAL_GPIO_WritePin(OV_RESET_GPIO_Port,OV_RESET_Pin,GPIO_PIN_RESET)
...
uint8_t OV2640_Init(void)
{
	...
	uint16_t reg;
 	...
 	OV2640_PWDN_Low;	//POWER ON
	HAL_Delay(50);
	OV2640_RST_Low;	//复位OV2640
	HAL_Delay(50);
	OV2640_RST_High;	//结束复位
	HAL_Delay(50);
